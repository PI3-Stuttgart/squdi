...
class SetupControlMainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowTitle('squdi: Setup Control QINU')
...
class SetupControlGui(GuiBase):
    ...
    # declare connectors
    # Setup_Control_Logic = Connector(interface='Setup_Control_Logic')
    ...
    def on_activate(self):
        ...
        label = self._get_switch_label('test_label')
        switch_widget = ToggleSwitchWidget(switch_states=('on', 'off'),
        ...
        self._mw.main_layout.addWidget(label, 0, 0)
        self._mw.main_layout.addWidget(switch_widget, 0, 1)
