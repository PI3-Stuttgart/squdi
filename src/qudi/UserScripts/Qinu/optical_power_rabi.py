...
def settings(pdc={}):
    ...
    nuclear.queue.awg._qm.set_digital_delay("Gate_Trigger", "trigger", 805 * u.ns)  # 805 # 820
    nuclear.queue.awg._qm.set_digital_delay("Memory_Trigger", "trigger", 805 * u.ns)  # 805 # 820
