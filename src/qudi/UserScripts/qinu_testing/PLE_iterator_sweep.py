            ...
            with infinite_loop_():
                ...
                with for_(*from_array(i_back, i_1_array[::-1])):
                    ...
                    with for_(j_back, 0, j_back < j_avg, j_back + 1):
                        play("pulse" * amp(0.01), "Laser_520", duration=back_scan_len / j_avg)
                ...
                with for_(*from_array(i_1, i_1_array)):
                    with for_(*from_array(i_2, i_2_array)):
                        ...
                        with for_(j, 0, j < j_avg, j + 1):
                            play("pulse" * amp(chk_i("620_laser_power")), "AOM_620", duration=readout_len / j_avg)
                            play("pulse" * amp(chk_i("repump_laser_power")), "Laser_520", duration=readout_len / j_avg)
