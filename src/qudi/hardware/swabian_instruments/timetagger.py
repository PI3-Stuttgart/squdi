...
class TT(Base):
    ...
    def correlation(self, **kwargs):
        ...
        return Correlation(self.tagger, self._corr["channel_start"], self._corr["channel_stop"], self._corr["binwidth"], self._corr["number_of_bins"])
    ...
    def counter(self, **kwargs):
        ...
        return Counter(self.tagger, self._counter["channels"], self._counter["bins_width"], self._counter["n_values"])
