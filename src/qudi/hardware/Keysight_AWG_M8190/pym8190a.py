...
import time
import threading
from qudi.core.module import Base #, ConfigOption
...
from qudi.interface.mcas_interface import McasDictHolderInterface

class mcas_dict_holder(McasDictHolderInterface):
